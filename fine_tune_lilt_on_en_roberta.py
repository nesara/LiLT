...
class CustomDataset(Dataset):
  ...
  def __getitem__(self, idx):
    ...
    for word, box, label in zip(words, boxes, ner_tags): #COMMENT: words= words, label= ner_tags
      for i in box:
        if i >1000:
          print("box grater than 1000 :- ",box) 
    ...
    encoding = self.tokenizer(words, boxes=boxes, truncation=True, max_length=512)
...
for word, box, label in zip(dataset["train"][0]["tokens"], dataset["train"][0]["bboxes"], dataset["train"][0]["ner_tags"]):
